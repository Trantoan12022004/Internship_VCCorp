...
export default function ChartView({ chartData, selectedFunction }) {
    ...
    // Báo cáo kinh doanh hôm nay (dạng object, không phải array)
        ...
        labels = ["Đơn hàng hôm nay", "Khách hàng hôm nay", "Sản phẩm bán ra", "Doanh thu hôm nay", "Giá trị TB đơn hàng"];
        values = [chartData.TodayOrders, chartData.TodayCustomers, chartData.TotalItemsSold, chartData.TodayRevenue, chartData.AvgOrderValue];
        ...
        datasets: [
            {
                label,
                data: values,
                backgroundColor: chartType === "pie" ? ["#36A2EB", "#FF6384", "#FFCE56", "#4BC0C0", "#9966FF", "#FF9F40"] : "rgba(54, 162, 235, 0.6)",
            },
        ],
    };
