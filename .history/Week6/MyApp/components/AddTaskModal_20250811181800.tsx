...
import {
    ...
    ScrollView,
    ActivityIndicator,
    useColorScheme, // Thêm này để detect system theme
} from "react-native";
import DateTimePickerModal from "react-native-modal-datetime-picker";
import { suggestAI } from "../services/api"; // Import API functions
...
export default function AddTaskModal({
        ...
        try {
            ...
            if (response && response.data && response.data.success) {
                ...
                if (suggestion) {
                    ...
                    Alert.alert("Thành công", "Đã nhận được gợi ý từ AI!");
                } else {
                    throw new Error("Không tìm thấy dữ liệu gợi ý trong response");
                }
            } else {
                throw new Error(response?.data?.message || "Phản hồi từ API không hợp lệ");
            }
        } catch (error: any) {
            console.error("Lỗi khi gọi AI suggestion:", error);

            // Xử lý các loại lỗi khác nhau
            let errorMessage = "Không thể lấy gợi ý từ AI. Vui lòng thử lại.";
    ...
    return (
        ...
        >
            ...
            {/* Date Picker Modal với Dark Mode Support */}
            <DateTimePickerModal
            ...
            {/* Time Picker Modal với Dark Mode Support */}
            <DateTimePickerModal
