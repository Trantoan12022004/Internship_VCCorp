...
const handleAISuggestion = async () => {
    ...
    try {
        ...
        // Sửa lại kiểm tra response structure theo backend response
        // Backend trả về: { success: true, message: "...", data: { taskInfo: {...}, suggestion: {...} } }
        if (response && response.success) {
            ...
            throw new Error(response?.message || "Phản hồi từ API không hợp lệ");
        }
