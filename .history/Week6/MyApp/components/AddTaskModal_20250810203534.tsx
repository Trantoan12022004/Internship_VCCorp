...
export default function AddTaskModal({
    ...
    const handleAISuggestion = async () => {
        ...
        try {
            ...
            // Thay YOUR_API_URL bằng URL API thật của bạn
            const response = await fetch("http://YOUR_API_URL/api/task/suggest-ai", {
                method: "POST",
                headers: {
            ...
            if (data.success && data.data.suggestion) {
                ...
                console.log("AI Suggestion received:", data.data.suggestion);
            } else {
                throw new Error(data.message || "Không thể lấy gợi ý từ AI");
            }
        } catch (error) {
            console.error("Lỗi khi gọi AI suggestion:", error);
            Alert.alert("Lỗi", "Không thể lấy gợi ý từ AI. Vui lòng thử lại.");
