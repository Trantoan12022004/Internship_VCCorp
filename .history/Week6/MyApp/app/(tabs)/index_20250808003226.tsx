...
// Cập nhật interface để khớp với dữ liệu từ API
interface Task {
    _id: string; // Đổi từ id thành _id
    title: string;
    description: string;
    date: string; // Format: "2025-08-08T00:00:00.000Z"
    time: string; // Format: "14:00"
    is_completed: boolean; // Đổi từ completed thành is_completed
}
...
export default function HomeScreen() {
    ...
    const generateCalendarDays = () => {
        ...
        // Tạo 7 ngày từ 3 ngày trước đến 3 ngày sau
        for (let i = -3; i <= 3; i++) {
            ...
            days.push({
                ...
                isActive: i === 0 // Ngày hiện tại là active
            });
        }
    ...
    const fetchTasks = async () => {
        try {
            ...
            if (response.data.success) {
                ...
                setTasks(allTasks);
                calculateStats(allTasks); // Tính toán thống kê
    ...
    const calculateStats = (allTasks) => {
        ...
        // Tính toán tuần này (từ Chủ nhật đến Thứ 7)
