...
import { getTask, createTask, loadCalendar } from "../../sevices/api";
...
export default function CalendarScreen() {
    ...
    // useFocusEffect: Chạy mỗi khi tab được focus
    ...
    useFocusEffect(
        useCallback(() => {
            ...
            return () => {
                console.log("Calendar tab unfocused");
            };
        }, [])
    );
    ...
    const getSelectedDateTasks = () => {
        ...
        const filteredTasks = tasks.filter((task) => {
            ...
            console.log(`Task "${task.title}": ${taskDateString} === ${selectedDateString} => ${taskDateString === selectedDateString}`);
    ...
    const handleDateSelect = (date: number, weekIndex: number) => {
        ...
        console.log("Selected date:", {
            ...
            dateString: newSelectedDate.toDateString(),
            localDateString: newSelectedDate.toLocaleDateString("vi-VN"),
        });
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <TouchableOpacity style={styles.loadCalendar} onPress={() => loadCalendar()}>
