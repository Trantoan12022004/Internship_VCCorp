...
export default function HomeScreen() {
    ...
    const generateCalendarDays = () => {
        ...
        // Tạo 7 ngày từ 3 ngày trước đến 3 ngày sau (sử dụng local date)
        for (let i = -3; i <= 3; i++) {
    ...
    // Tính toán thống kê tasks cho tuần này
    const calculateStats = (allTasks: Task[]) => {
        const now = new Date();

        // Tạo start/end của tuần theo local date
        ...
        // Convert to YYYY-MM-DD format để so sánh
