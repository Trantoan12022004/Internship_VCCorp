...
export default function HomeScreen() {
    ...
    const toggleTaskCompletion = async (taskId: string) => {
        ...
        try {
            ...
            calculateStats(previousTasks);

            Alert.alert(
                "Lỗi",
                "Không thể cập nhật trạng thái task. Vui lòng kiểm tra kết nối mạng và thử lại.",
                [{ text: "OK" }]
            );
        }
    };
                        ...
                        {selectedDateTasks.length > 0 ? (
                            selectedDateTasks.map((task) => (
                                <View key={task._id} style={styles.taskItem}>
                                    ...
                                    <TouchableOpacity style={styles.taskMenu} activeOpacity={0.7}>
