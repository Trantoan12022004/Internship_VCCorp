...
import { getTask, updateTask } from "../../sevices/api";
...
export default function HomeScreen() {
    ...
    const toggleTaskCompletion = (taskId: string) => {
        ...
        // Cập nhật task trên server (nếu cần)
        updateTask(taskId, { is_completed: !updatedTasks.find((t) => t._id === taskId)?.is_completed })
            .then(() => console.log("Task updated on
