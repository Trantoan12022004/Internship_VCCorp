...
export default function CalendarScreen() {
    ...
    useEffect(() => {
        fetchTasks();
        generateCalendar();
    }, [currentDate, fetchTasks, generateCalendar]);
    ...
    // Tạo calendar dựa trên tháng hiện tại
                                    ...
                                    >
                                        <Text
                                            style={[
                                                ...
                                                isSelected(date, weekIndex) && styles.selectedDateText,
                            ...
                            <View key={task._id} style={styles.eventCard}>
                                <View
                                    style={[
                                        ...
                                        { backgroundColor: task.is_completed ? "#4CAF50" : "#4566EC" },
                                    ]}
                                />
