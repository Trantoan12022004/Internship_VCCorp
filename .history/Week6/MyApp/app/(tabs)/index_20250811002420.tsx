...
import NotificationService from "../../services/notificationServiceotificationService";
...
export default function HomeScreen() {
    ...
    const fetchTasks = useCallback(async () => {
        try {
            ...
            if (response.data.success) {
                ...
                await NotificationService.scheduleMultipleTaskReminders(allTasks);
    ...
    // Create new task - Updated with notification scheduling
    ...
    // Delete task - Updated with notification cancellation
