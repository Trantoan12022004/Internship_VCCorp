...
import { getTask, updateTask, createTask, deleteTask } from "../../sevices/api";
...
export default function HomeScreen() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            {/* Add New Task Button */}
            <TouchableOpacity style={styles.loadCalendar} onPress={() => {// Gọi API sync Google Calendar
        console.log("Load Google Calendar");
        // Có thể thêm function fetchGoogleCalendarTasks() ở đây}}>
