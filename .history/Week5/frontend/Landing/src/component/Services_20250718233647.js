...
export default class Services extends Component {
    ...
    sendMessage = async (e) => {
        ...
        this.setState((prevState) => ({
            ...
            inputMessage: "",
            isLoading: true,
            chartData: null, // reset chartData khi gửi câu hỏi mới
        }));
        try {
            // Gọi API analyzeQuery với field "text"
            ...
            // Nếu có dữ liệu dạng bảng (mảng), lưu vào chartData để hiển thị biểu đồ
            this.setState((prevState) => ({
                messages: [...prevState.messages, systemMessage],
                isLoading: false,
                chartData: Array.isArray(apiData?.data) ? {
                    data: apiData.data,
