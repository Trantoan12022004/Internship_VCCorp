...
export default class Services extends Component {
    ...
    sendMessage = async (e) => {
        ...
        try {
            // Gọi API analyzeQuery với field "question"
            ...
            const systemMessage = {
                id: Date.now() + 1,
                text: response.data.data || response.data.message || response.data.response || "Xin lỗi, tôi không thể xử lý yêu cầu của bạn lúc này.",
                sender: "system",
                timestamp: new Date().toLocaleTimeString(),
            };
