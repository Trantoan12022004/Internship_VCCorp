        ...
        <Layout title="🏠 Trang Chủ" subtitle="Chào mừng bạn đến với My Vite React App">
            <div className={styles.container}>
                <section className={styles.hero}>
                    ...
                    <p className={styles.heroDescription}>Được xây dựng với Vite, React 19 và CSS Modules</p>
                </section>
                ...
                <section className={styles.demo}>
                    <div className={styles.card}>
                        ...
                        <div className={styles.actions}>
                            <Button onClick={handleIncrement} loading={loading} disabled={loading}>
                                Tăng
                            </Button>
                            <Button variant="secondary" onClick={handleReset} disabled={count === 0}>
                                Reset
                            </Button>
                        </div>
                    </div>
