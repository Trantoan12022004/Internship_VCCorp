...
const Chat = () => {
    ...
    const sendMessage = async (e) => {
        ...
        try {
            // Gọi API analyzeQuery thay vì fetch
    ...
    return (
        <div className={styles.chatContainer}>
            <div className={styles.chatHeader}>
                <h2>Chat Hỗ Trợ</h2>
                <Button variant="secondary" size="small" onClick={clearChat} className={styles.clearButton}>
                    Xóa Chat
                </Button>
            </div>
            ...
            <div className={styles.messagesContainer}>
                {messages.map((message) => (
                    <div key={message.id} className={`${styles.message} ${message.sender === "user" ? styles.userMessage : styles.systemMessage}`}>
